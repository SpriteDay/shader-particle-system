...
declare const SPE: {
    ...
    utils: {
        ...
        randomColorAsHex: (attribute: import("./utils/index").ShaderAttribute, index: number, base: import("three").Color[], spread: import("three").Vector3[]) => void;
        ...
        randomDirectionVector3OnSphere: (attribute: import("./utils/index").ShaderAttribute, index: number, posX: number, posY: number, posZ: number, emitterPosition: import("three").Vector3, speed: number, speedSpread: number) => void;
        randomDirectionVector3OnDisc: (attribute: import("./utils/index").ShaderAttribute, index: number, posX: number, posY: number, posZ: number, emitterPosition: import("three").Vector3, speed: number, speedSpread: number) => void;
